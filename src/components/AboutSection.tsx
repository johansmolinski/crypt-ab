  ...
  return (
    <section id="about" className="border-b border-border px-6 lg:px-12 py-16">
      ...
      <div className="max-w-[58ch]">
        <p className="text-foreground text-sm leading-[1.85] mb-6">
        ...
        <p className="text-foreground text-sm leading-[1.85] mb-6">
          The approach is grounded in pragmatic problem-solving, long-term thinking, and a commitment to building software that simply works. Every engagement benefits from over a decade of hands-on experience with complex systems, distributed architectures, and real-world constraints.
        </p>
